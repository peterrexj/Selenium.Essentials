...
$sapiExt = [IO.Path]::Combine($PSScriptRoot, '..\src\TestAny.Essentials.Api.Extensions\TestAny.Essentials.Api.Extensions.csproj')
...
dotnet pack $sapiExt --output $pjOutput
